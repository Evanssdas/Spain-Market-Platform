...
| Item | Value | Type |
|---|---:|---|
| Latest observed daily peak | €238.74/MWh | market data |
| 30-day volatility of daily changes | €22.43/MWh | calculated |
...
|---|---:|---:|
| Long 100 MWh | €3,690 | €5,218 |

VaR is not a maximum possible loss.

## Volatility regime

- 30-day volatility: **€22.43/MWh**
- 90-day volatility: **€29.95/MWh**
- Regime: **NORMAL**
...
- VaR-derived maximum: **271 MWh**
- Separate volume maximum: **2,000 MWh**
- Binding maximum: **271 MWh**

## Latest model forecast

- Target date: **2026-09-02**
- Forecast daily peak: **€196.64/MWh**
- Forecast firm residual demand: **253,734 MWh**
